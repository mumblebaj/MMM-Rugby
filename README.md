...
| `competitions`               | Only used where collectionType is set to `free`. Can be removed when setting collectionType = `apiSport`. <br> An array of leagues can now be selected to filter the Selected Rugby Union (sport). <br> ** Woman's Sevens Series 2024 ** <br> - `Women's Sevens Series 2024` <br> - `World Rugby Sevens Challenger Series - Women 2024` <br> ** Mens Sevens Series 2024 ** <br> - `Men's Sevens Series 2024` <br> - `World Rugby Sevens Challenger Series - Men 2024` <br> ** U20 Six Nations 2024 ** <br> - `U20 Six Nations 2024` <br> - `World Rugby U20 Trophy 2024` <br> ** Mens Rugby Union ** <br> - `Six Nations 2024` <br> - `Rugby Europe International Championship 2024` <br> - `Men's Internationals 2024` <br> - `Rugby Europe Trophy 2024` <br> - `Rugby Europe Conference 2024` <br> - `Autumn Nations Series 2024` <br> - `The Rugby Championship 2024` <br> - `Asia Rugby Championship 2024` <br> - `World Rugby Pacific Challenge 2024` <br> - `Pacific Nations Cup 2024` <br> - `Autumn Nations Series 2024` <br> ** Womans Rugby Union ** <br> - `Rugby Europe Championship 2024` <br> - `Women's Internationals 2024` <br> - `Women's Six Nations 2024` <br> - `Pacific Four Series 2024` <br> - `Asia Rugby Women’s Championship 2024` <br> - `O'Reilly Cup 2024`<br><br> If option is not selected then all Leagues will be returned.
