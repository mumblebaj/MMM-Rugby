...
| `sport`                      | The Rugby League to get data for with competitions <br> **Possible values:** <br> `wrs`: Woman's Sevens Series 2024 <br> - `Women's Sevens Series 2024` <br> - `World Rugby Sevens Challenger Series - Women 2024` <br> `mrs`: Mens Sevens Series 2024 <br> - `Men's Sevens Series 2024` <br> - `World Rugby Sevens Challenger Series - Men 2024` <br> `jmu`: U20 Six Nations 2024 <br> - `U20 Six Nations 2024` <br> - `World Rugby U20 Trophy 2024` <br> `mru`: Includes a number of leagues <br> - `Six Nations 2024` <br> - `Rugby Europe International Championship 2024` <br> - `Men's Internationals 2024` <br> - `Rugby Europe Trophy 2024` <br> - `Rugby Europe Conference 2024` <br> - `Autumn Nations Series 2024` <br> - `The Rugby Championship 2024` <br> - `Asia Rugby Championship 2024` <br> - `World Rugby Pacific Challenge 2024` <br> - `Pacific Nations Cup 2024` <br> - `Autumn Nations Series 2024` <br> `wru`: Womans Rugby Union <br> - `Rugby Europe Championship 2024` <br> - `Women's Internationals 2024` <br> - `Women's Six Nations 2024` <br> - `Pacific Four Series 2024` <br> - `Asia Rugby Women’s Championship 2024` <br> - `O'Reilly Cup 2024` <br> Can be removed when collectionType is set to `apiSport`.
